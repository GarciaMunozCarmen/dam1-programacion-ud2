...
public class TrabajandoConMetodos {
    public static void main(String[] args) {
        ...
        // Tu código aquí ↓
         Cancion c1 = new Cancion("Original", "Yo");
...
// Respuesta: Que no te devuelve nada

// Ejercicio 2: ¿Qué diferencia hay entre un método void y uno con retorno?
// Respuesta: Un método void no devuelve nada y uno con retorno te devuelve algo, por ejemplo el método suma te devuleve la suma de dos números
